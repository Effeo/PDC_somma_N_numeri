...
# Print the data with speedup and efficiency
print(df.to_string(index=False))
...
plt.figure()
group = df[df['Number of Processors'] == 4]
plt.plot(group['Matrix Size'], group['Speedup'], label=f'Number of Processors 4')
plt.xlabel('Matrix Size')
plt.ylabel('Speedup')
plt.legend()
...
plt.figure()
group = df[df['Number of Processors'] == 4]
plt.plot(group['Matrix Size'], group['Efficiency'], label=f'Number of Processors 4')
plt.xlabel('Matrix Size')
